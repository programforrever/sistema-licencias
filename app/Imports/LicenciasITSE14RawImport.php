...
/**
 * Importador SIMPLE para ITSE 14 - Solo guarda datos crudos del Excel
 */
class LicenciasITSE14RawImport
{
    private const TIPO = 'anexo_14';
    ...
    public function preview(string $filePath): array
    {
        ...
        try {
            ...
            Log::error("Error en preview ITSE 14 RAW: " . $e->getMessage());
        }
        ...
        try {
            ...
            for ($rowIndex = 2; $rowIndex <= $totalRows; $rowIndex++) {
                ...
                try {
                    ...
                    $this->errores++;
                    Log::error("Error importando fila $rowIndex ITSE14: " . $e->getMessage());
                }
            }
            ...
            DB::rollBack();
            Log::error("Error crítico ITSE 14 RAW: " . $e->getMessage());
            throw $e;
        }
